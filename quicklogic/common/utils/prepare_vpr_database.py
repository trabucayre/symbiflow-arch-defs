...
from data_structs import Loc, ClockCell, Cell, Tile, TileType, LocMap, VprSwitch, VprSegment
from data_structs import ConnectionType, ConnectionLoc, Connection, PackagePin, Quadrant
...
def main():
    ...
    grid_size = (GRID_MARGIN[0] + GRID_MARGIN[2] + (grid_max[0] - grid_min[0] + 1),
                 GRID_MARGIN[1] + GRID_MARGIN[3] + (grid_max[1] - grid_min[1] + 1))
