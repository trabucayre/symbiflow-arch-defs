...
from data_structs import SwitchboxPinType, OPPOSITE_DIRECTION, ConnectionLoc
from data_structs import PinDirection, Connection, Loc, ConnectionType
...
def build_hop_connections(switchbox_types, switchbox_grid):
    ...
    for dst_loc, dst_switchbox_type in switchbox_grid.items():
        ...
        for dst_pin in dst_pins:
            ...
            if len(src_pins) != 1:
                print(
                    "WARNING: No output pin '{}' in switchbox '{}' at '{}' for \
input '{}' of switchbox '{}' at '{}'"
                    .format(
