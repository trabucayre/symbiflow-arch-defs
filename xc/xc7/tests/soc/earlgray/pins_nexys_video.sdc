...
create_clock -period 20.000 clk_50_buf -waveform {0.000 10.000}
create_clock -period 20.833 clk_48_buf -waveform {0.000 10.416}
create_clock -period 10.000 clk_fg_buf -waveform {0.000 5.000}
